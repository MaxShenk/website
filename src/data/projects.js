...
const PythonSkill = allSkills[12];
const PytorchSkill = allSkills[13];
...
function project_6() {
	return {
		date: "Fall 2023",
		title: "Bird Identifier AI",
		description:
			"A Deep Learning Neural Network for bird image species classification.",
		keywords: [
			"AI",
			"Maxwell",
			"Maxwell S",
		...
		body: (
			<React.Fragment>
				...
				<hr height= "9px" />
				<h1>Project History</h1>
				<div className="paragraph"> During my final semester of University, I worked in my Machine Learning class to create a Image Recognition Neural Network. It works by loading in images of birds then classifing
				them into one of 50 classes. I used Python Jupiter notebooks then Pytorch for the programming. It ended with an 85% classification accuracy on an unseen testing set.  
				 </div>
				 <hr className="project-hor-line"/>
				</div>
			</React.Fragment>
...
function project_7() {
	return {
		...
		title: "Bird Identifier AI",
		description:
			"A real-time Smoothed Particle Hydrodynamic simulator in Unity with Raymarched meshing.",
		keywords: [
			"Water",
			"Maxwell",
			"Maxwell S",
		...
		body: (
			<React.Fragment>
				<div className="project-content">
				<video className="video-content" src="../Watery.mp4" width="100%" height="100%" controls="controls" autoplay="true" />

				<p></p>
				<hr height= "9px" />
				<h1>Project History</h1>
				<div className="paragraph"> I created a real-time water/fluid simulation from scratch in Unity using C#. It is based on a paper about Smooth Particle Hydrodynamics. It is a particle based fluid simulation.
				I also created a raymarching shader script for shading the fluid. It is capable of spherical outside collisions and can function with a real-time changing number of particles, using a spigot and drain system. 
				 </div>
				 <hr className="project-hor-line"/>
				</div>
			</React.Fragment>
...
const myProjects = [project_1, project_2,project_3,project_4,project_5,project_6,project_7];
